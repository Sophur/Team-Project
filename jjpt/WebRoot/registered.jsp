...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="<%=path%>/js/jquery/jquery-1.4.2.min.js">
		</script>
						        ...
						        <input type="hidden" name="fujianYuanshiming" id="fujianYuanshiming"/>
											...
											<tr>
												...
												<td>
													...
													name="userinfo.type" cssClass="box1" listKey="key"
											...
											<tr>
												...
												<td>
													<s:select list="#request.kmlx" theme="simple"
													name="userinfo.style" cssClass="box1" listKey="key"
													listValue="value"></s:select>
