							...
							<div class="m_border">
								...
								<div class="m_content message_con">
									<form id="form1" name="form1" method="post"
										action="<%=path%>/xun!addXunFr.action"
										>
										<p class="tips">
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<td width="35%">	
												<input id="title" name="xun.title" class="text"	
										...
										<tr>	
											...
											<td width="35%">	
												...
												<textarea style="width: 600px; height: 250px; visibility: hidden;" name="xun.info"></textarea>			
										...
										<tr>	
											...
											<td width="35%">	
												<input id="lianxiren" name="xun.lianxiren" class="text"	
										...
										<tr>	
											...
											<td width="35%">	
												<input id="tel" name="xun.tel" class="text"	
													style="width: 154px" value="" />	
										...
										<tr>	
											...
											<td width="35%">	
												<input id="qq" name="xun.qq" class="text"	
													style="width: 154px" value="" />	
...
KindEditor.ready(function(K) {
	editor = K.create('textarea[name="xun.info"]', {
		resizeType : 1,
