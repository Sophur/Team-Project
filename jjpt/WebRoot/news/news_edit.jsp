									...
									<table border="0" cellpadding="2" cellspacing="1"	
										...
										<tr>	
											...
											<td width="35%">	
												<input id="title" name="news.title" class="text"	
													style="width: 154px" value="${news.title}" />	
										...
										<tr>	
											...
											<td width="35%" colspan="3">	
												...
												<textarea style="width: 600px; height: 250px; visibility: hidden;" name="news.info">${news.info}</textarea>		
...
function save() {	
	...
	if ($("#password").val() == "") {	
		...
		editor.sync();
	document.forms[0].action = "<%=path%>/news!editNews.action";	
